...
-- ========================================
-- USER 1 (Client - John Smith) - Project 1
-- ========================================
...
-- ========================================
-- USER 21 (Freelancer - Alex Developer) - Project 1
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
...
-- ========================================
-- USER 2 (Client - Sarah Johnson) - Project 2
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
...
-- ========================================
-- USER 22 (Freelancer - Maria Designer) - Project 2
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
...
-- ========================================
-- USER 3 (Client - Michael Williams) - Project 3 (IN_PROGRESS)
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
...
-- ========================================
-- USER 23 (Freelancer - Carlos Writer) - Project 3
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
...
-- ========================================
-- Payment failure notification (User 8)
-- ========================================
INSERT INTO notifications (user_id, type, title, message, is_read, email_sent, recipient_email, related_entity_type, related_entity_id, created_at, read_at, metadata) VALUES
